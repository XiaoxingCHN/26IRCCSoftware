...
/**
  ...
  */
extern float PID_Calculate_Position(PID_Info_TypeDef *PID, float Target,float Measure);
extern float PID_Calculate_Increment(PID_Info_TypeDef *PID, float Target,float Measure);
